          ...
          <div className="container">
            <div className="section-header">
              ...
              <p className="section-subtitle">
                Everything you need to know about Must-Gate
              </p>
            </div>

            <div className="faq-grid">
              <div className="faq-item">
                <h3 className="faq-question">How do I register for Must-Gate?</h3>
              ...
              <div className="faq-item">
                <h3 className="faq-question">Which gates support Must-Gate?</h3>
                <p className="faq-answer">
              ...
              <div className="faq-item">
                <h3 className="faq-question">
                  Can I use Must-Gate with multiple vehicles?
                </h3>
                <p className="faq-answer">
        ...
        <footer className="footer" id="footer">
          <div className="container">
            ...
            <div className="footer-bottom">
              <p>
                &copy; 2025 Must-Gate. All rights reserved. A Ministry of Transport
                Initiative.
              </p>
